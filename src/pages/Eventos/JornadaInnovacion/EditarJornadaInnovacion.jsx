...
const EditarJornadaInnovacion = (props) => {
  ...
  /*const handleChangeNombreEvento = (event) => {
  ...
  const onSubmit = (data) => {
    ...
    if (areValidDates && areAllInputsFilled) {
      ...
      data.allow_inscripcion = allow_inscripcion;
      data.allow_asistencia = allow_asistencia;
  ...
  fechas.forEach((fecha, index) => {
    ...
    fechasDateFormat.push(new Date(formattedDate));
  });
    ...
    return (
      <>
        <input
          ...
          readOnly
          type="text"
          className="font-light p-2 rounded-lg text-sm w-full border border-primary_gray_5 bg-white outline-none focus:ring-2 focus:ring-inset focus:ring-primary_color_1"
          placeholder=""
          onChange={onChange}
        />
      </>
  ...
  return (
    <>
      <div className="flex justify-center bg-white rounded-lg pb-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="px-10 py-8 rounded-lg grid grid-cols-12 gap-6 w-[600px] bg-white  border border-primary_gray_5 ">
            {/**Nombre */}
            <div className="col-span-12 flex flex-col">
              <span className="text-lg font-normal text-primary_color_1">
                Nombre
              </span>
              <input
                type="text"
                ...
                {inputs.map((input) => (
                  <div key={input.id} className="flex gap-4">
                    <div className="flex flex-col w-full bg-white rounded-lg p-3 gap-1 border-[1px]">
                      <span className="text-sm font-normal text-primary_color_1">
                        Nombre del Taller
                      </span>
                      <input
                        type="text"
