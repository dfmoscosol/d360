...
const JornadaInnovacionCard = (props) => {
  ...
  return (
    <div className="bg-white p-4 flex flex-col gap-4 rounded-lg hover:shadow-lg transition-all duration-300 h-full border-l-4 hover:scale-[1.02] cursor-pointer" style={{ borderLeftColor: '#001F66' }}>
      <Link
        to={`verEvento/${id}`}
      ...
      >
        <div className="flex flex-col items-start gap-2 w-full">
          ...
          <EventTypeBadge type={1} typeName="Jornada de Innovación" />
        </div>
